...
| File | Use it for |
|---|---|
| `ASSETS_README.md` | Know which assets are placeholders vs production-ready |
...
| Item | Why |
|---|---|
| `kit/poster.jpg` | **Placeholder** — generated by PIL script, not production-ready |
| `kit/product.glb` | **Placeholder cube** — generated by pygltflib, replace with real model |
